    ...
    for i in range(len(location_array)):
        for j in range(len(location_array[i])):
            ...
            if coordinates is not None:
                ...
                weather_data = get_elevation(coordinates[0], coordinates[1], API_KEY)
...
# Example usage:
test_location_array = [
    [None, (38.9697, -77.385, 0), None, None, (38.9697, -77.385, 1), None, None, None, None, None, None, None, None, None, None, None, None, None, None, None, None, None, None, None, None, None, None, None, None, None, None],
